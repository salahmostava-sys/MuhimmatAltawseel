...
const _TOOL_HANDLERS = {
  get_employee_stats:    (sb, _args, _role, _ctx) => _toolEmployeeStats(sb),
  get_vehicle_status:    (sb, _args, _role, _ctx) => _toolVehicleStatus(sb),
  ...
  get_advances_summary:  (sb, _args, _role, _ctx) => _toolAdvancesSummary(sb),
  ...
  get_employee_details:  (sb, args, role, _ctx)   => _toolEmployeeDetails(sb, args, role),
  get_platform_accounts: (sb, _args, _role, _ctx) => _toolPlatformAccounts(sb),
