...
export const AUTH_FORM_INPUT_BASE =
  'min-h-[56px] py-4 px-4 text-[16px] md:text-[16px] font-bold leading-normal rounded-xl border-border bg-background shadow-sm focus-visible:ring-2 focus-visible:ring-primary/30 [&::placeholder]:text-base [&::placeholder]:font-normal [&::placeholder]:opacity-70';
