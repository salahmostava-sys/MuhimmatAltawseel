...
/** How long the user can be idle before auto-logout (default: 2 minutes). */
export const SESSION_INACTIVITY_TIMEOUT_MS = 2 * 60 * 1000;

/** Warning toast fires this many ms before the timeout (default: 30 s). */
