...
export type DashboardTabKey = 'overview' | 'analytics';
          ...
          {(['overview', 'analytics'] as const).map((tab) => {
            ...
            return (
              <button
                ...
                onFocus={isAnalyticsTab ? onAnalyticsIntent : undefined}
                onMouseEnter={isAnalyticsTab ? onAnalyticsIntent : undefined}
                onTouchStart={isAnalyticsTab ? onAnalyticsIntent : undefined}
                className={cn(
